...
-	There are A LOT of assumptions in these estimates, and the uncertainties are large
...
We downloaded all the flight arrivals into Ireland from [flightradar24.com](http://www.flightradar24.com) since the beginning of the year. This website provided us with useful information about the number of planes flying to Ireland, plane type, travel origin and date of the travel. Here is a plot of all the flights. You can really see where the pandemic kicked in and passenger numbers dropped off the cliff:

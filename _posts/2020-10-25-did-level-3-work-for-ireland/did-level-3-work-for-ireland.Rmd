...
Current [timeline](https://en.wikipedia.org/wiki/COVID-19_pandemic_in_the_Republic_of_Ireland#Second_Wave,_Tightening_of_Restrictions_and_Second_National_Lockdown_(August_2020–present)) of events over the past few months of the 'second wave':
...
# Task 1: Look at Dublin's level of disease and positivity rate
...
This seems to show that Dublin wasn't rising that much in the first place, but that the peak in cases came _after_ three weeks of level 3 ended. But perhaps at the same time the number of tests rose?
...
Unfortunately they don't provide the number of tests per county so it's hard to calculate the positive rate for Dublin only. They do provide an estimate of the positivity rate across the last 7 days (again for the whole country):
...
This seems to show that the positivity rate rose, and was continuing to rise, all the way through that period. So this shows that, if level 3 worked, it took longer than 4 weeks, nearer 5. Worse, it seems that the number of tests were pretty stable during this period, whilst the number of cases in Dublin seemed to rise during the 5th week.

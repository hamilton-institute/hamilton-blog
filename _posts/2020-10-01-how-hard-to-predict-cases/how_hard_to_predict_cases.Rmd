...
author:
  - name: Rafael Moral
    url: https://www.maynoothuniversity.ie/people/rafael-de-andrade-moral
  - name: Thiago Oliveira
    url: https://prof-thiagooliveira.netlify.app
  - name: Andrew Parnell
...
- We constantly update forecasts and make all results freely available to any country in the world through a web [app](https://rstudioserver.hamilton.ie:3838/users/aparnell/pred_app/)
...
<iframe src="forecast.pdf" style="width:600px; height:500px;" frameborder="0"></iframe>
